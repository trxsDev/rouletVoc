...
class TargetFocusScreen:
    ...
    def update_audio(elapsed, target_item, voice_count_ref):
        ...
        # 2nd Pronunciation at 2.8s (Pause for children to hear clearly)
    ...
    def draw(surface, cards, target_item, elapsed, voice_count):
        ...
        dim.fill((15, 23, 42, int(t * 228)))
        surface.blit(dim, (0, 0))

        # 3. Interpolate Target Card Rect (Grid -> Center Stage 420x440)
        ...
        surface.blit(th_surf, th_surf.get_rect(center=(draw_rect.centerx, draw_rect.centery + int(70 + t * 60))))
